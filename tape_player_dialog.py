...
class TapePlayerDialog(QDialog):
    ...
    def __init__(self, parent=None, initial_path: str | None = None):
        ...
        self.file_btn = QPushButton("Abrir cinta…")
        ...
        self.device_btn = QPushButton("Examinar directo…")
        self.device_btn.setToolTip("Saltar el selector e ir directo al explorador de archivos")
