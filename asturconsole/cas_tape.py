...
El decodificador WAV→CAS está pensado para audio limpio generado
digitalmente (por esta misma herramienta, por un emulador, etc.), no para
grabaciones reales de casete con ruido/deriva de velocidad: para eso ya
existen herramientas especializadas como castools (wav2cas), que aplican
control de umbral, envolvente y fase para tolerar señal degradada.
"""
...
def measure_signal(wav_bytes: bytes) -> tuple[int, float, float, float]:
    ...
    periodo_agudo = conteo.most_common(1)[0][0]
