...
class SystemPanel(QWidget):
    def __init__(self, system: str, accent_getter):
        ...
        self.workspace_btn = QPushButton("Carpeta de trabajo")
    ...
    def _open_workspace(self):
        QDesktopServices.openUrl(QUrl.fromLocalFile(ws.ensure_workspace()))
    ...
    def _build_tape_tools(self) -> QWidget:
        ...
        btn_blank.clicked.connect(self._create_blank_disks)
    ...
    def _render_dsk_view(self, dsk_name: str, dsk: rf.DskImage):
        ...
        extract_all_btn = QPushButton("📤 Extraer todo el disco…")
        extract_all_btn.clicked.connect(lambda: self._extract_all(dsk, dsk_name))
        top_row.addWidget(extract_all_btn)
